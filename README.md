...
# How to Useage.  
    ...
    ![](https://raw.githubusercontent.com/YoungsoonLee/kira/master/images/ps.png)  
    ...
    * you can receive HTTP 200 code success when there is no overlap data
    ![](https://raw.githubusercontent.com/YoungsoonLee/kira/master/images/200.png)  

    * if you try abow curl again, you can receive HTTP 400 code Bad request(there is overlap data) and overlap data.
    ![](https://raw.githubusercontent.com/YoungsoonLee/kira/master/images/400.png)  
